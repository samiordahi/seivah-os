...
export default function Conversations() {
  ...
  return (
    <>
      <DashboardLayout>
        <div className="flex flex-col h-[calc(100vh-12rem)] pb-20">
          {/* Chat Messages Area */}
      ...
      {/* Fixed Input Area - Aligned with sidebar footer */}
      <div className="fixed bottom-0 right-0 left-64 border-t border-border/50 backdrop-blur-sm p-4 bg-card/60">
        <form onSubmit={e => {
        e.preventDefault();
        handleSend();
      }} className="relative">
