...
import { MIXED_PROMPT } from './prompt.ts';
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Mixed Agent - Response received');
    ...
    console.error('Error in mixed-agent function:', error);
    return new Response(
      JSON.stringify({ 
        success: false,
        error: error.message,
